...
RELEASE_NAME = "dxlirflowservice-python-dist-" + str(VERSION)
CONFIG_RELEASE_NAME = "dxlirflowservice-python-dist-config-" + str(VERSION)
...
subprocess.check_call(["sphinx-apidoc",
                       ...
                       os.path.join(DIST_PY_FILE_LOCATION, "dxlirflowservice")])
